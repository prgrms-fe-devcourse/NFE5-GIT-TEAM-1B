...
✍🏻 정기전: 매월 첫째,셋째 수요일 21시   
    (정기전 비: 15,000원, 게스트: 18,000원)
...
모집합니다🙂🙃`,
  ...
  {
    title: `🔥콕깍지🔥 2030 배드민턴🏸`,
    introduction: `🏸배드민턴에 콩깍지가 씌여버린 사람들의 모임🏸
🤗문의 카톡(laba1593) 인스타(2high_uk)
🏅매주 월요일마다 장기미참석자 인원정리❗️❗️❗️

🏸 장소 : 강동 일자산 제1체육관
   (9호선 중앙보훈역 도보5분거리)
🏅정모 : 매일 오전9:20 저녁7:00 / 3시간 운동
 (월요일제외 - 체육관 휴관)
🤗문의 카톡(laba1593) 인스타(2high_uk)
🏅나이제한 : 05년생 ~ 83년생
   (예외-지인추천)
🏅열!정!있는! 초보자!, 구력자 모두 환영 😍
  🚨단, 매너 없는 분, 유령회원, 홍보 목적 제외
  🚨특히, 입문자의 경우!!! 어쩌다 한번씩 나와서 놀고가겠다고 생각하시는 분들은 가입❌
  🚨입문자의 경우 주2회이상 참석가능자만 가입⭕
🏅가입 후 24시간 이내 자기소개서 작성 📝
